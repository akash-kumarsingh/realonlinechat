...
const SECTIONS = [
  ...
  {
    title: 'Third parties',
    body: 'We do not sell, rent, or share your data with third parties for marketing. We use infrastructure providers (hosting, databases) that process data on our behalf under strict agreements.',
  },
  {
    title: 'Your rights',
